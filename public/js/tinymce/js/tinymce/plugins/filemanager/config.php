...
$upload_dir = '/imageuploads/'; //'/tinymce/source/'; // path from base_url to upload base dir
$current_path = '../../../../../../imageuploads/'; // relative path from filemanager folder to upload files folder
